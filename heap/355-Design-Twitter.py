...
# Approach: Use hashmaps to keep track of user tweets and followees. Take most recent tweet from self and all followees and put into heap to get most recent post cycling until heap is empty or 10 posts are found.
# Complexity: O(n log n) getNewsFeed, O(1) rest, O(n) space
# Enjoyment: 3/5
