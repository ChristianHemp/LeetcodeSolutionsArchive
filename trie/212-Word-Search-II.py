...
# Approach: Use trie to store words and use backtracking dfs to search for words at each index of the matrix
# Complexity: O(rows * cols * 4^words) time, O(rows * cols * 4^words) space
# Enjoyment: 3/5
