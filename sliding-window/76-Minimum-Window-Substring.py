...
# Approach: Two hashmap approach to keep track of character counts, use sliding window to find window of matching chars and decrement left pointer until invalid.
