...
# Approach: Backtracking dfs for each char in grid that starts with the first char in target word
# Complexity: O(n * m * 3^k) time, O(l) space where n is rows, m is cols, and l is length of word
# Enjoyment: 5/5
