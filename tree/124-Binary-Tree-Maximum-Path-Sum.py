...
# Approach: Keept track of global max path sum found. Use postorder dfs first calculating max path sum without parent nodes then return current node value plus larger of two subtrees (if positive)
